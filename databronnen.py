...
cijfers_buurten_en_wijken = {'leeftijd_2015':('./age_data/age_data_2015.xlsx',
                             ...
                             'BuurtenenWijken_2015':('83220NED',process_data_buurten),
                             'BuurtenenWijken_2016':('83487NED',process_data_buurten),
                             'BuurtenenWijken_2017':('83765NED',process_data_buurten),
                             'BuurtenenWijken_2018':('84286NED',process_data_buurten),
                             'jongeren_2015':('82964NED',process_data_jongeren),
                             'jongeren_2016':('83563NED',process_data_jongeren),
                             'jongeren_2017':('83782NED',process_data_jongeren),
                             'wmo_2015':('83267NED',process_data_wmo),
                             'wmo_2016':('83620NED',process_data_wmo),
